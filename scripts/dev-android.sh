#!/usr/bin/env bash
# dev-android.sh — Start Android live-reload dev session.
#
# What it does:
...
#   5. Opens Android Studio — build & run on device from there
#
...
CAPACITOR_SERVER_URL="http://$IP:$VITE_PORT" npx cap sync android
echo ""

# ── 5. Open Android Studio ────────────────────────────────────────────────────
echo "🚀  Opening Android Studio — build & run on your device from there."
