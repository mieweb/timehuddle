...
- **Edit post** always opens a working editor. It could come up as an empty box
  with no toolbar and no sign of the post you were editing; when the live
  co-editing part can't load, the composer now falls back to the ordinary
  editor with your text in it.
